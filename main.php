    ...
    <div id="main">
        ...
        <div class="footer">
            <div class="pure-menu pure-menu-horizontal">
                <ul>
                    <li class="pure-menu-item"><a name="About Link" onclick="handleOutboundLinkClicks(this)" href="http://www.beryl8.com/about-beryl8/" class="pure-menu-link">About</a></li>
                    <li class="pure-menu-item"><a name="Twitter Link" onclick="handleOutboundLinkClicks(this)" href="https://twitter.com/beryl8plus" class="pure-menu-link">Twitter</a></li>
                    <li class="pure-menu-item"><a name="Facebook Link" onclick="handleOutboundLinkClicks(this)" href="https://www.facebook.com/beryl8plus" class="pure-menu-link">Facebook</a></li>
                </ul>
            </div>
        </div>
    </div>
